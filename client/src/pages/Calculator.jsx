...
export function Calculator() {
  const [percentile, setPercentile] = useState("95.50");
  const [totalStudents, setTotalStudents] = useState(330000); // Default PCM approx 3.3 Lakhs

  const calculateRank = (pct, total) => {
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-400 font-medium">
                Predict your State Merit Rank based on MHT-CET Percentile
              </p>
            </div>
          </div>
        </div>
