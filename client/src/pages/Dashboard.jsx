...
export function Dashboard() {
  ...
  const capSteps = [
    {
      name: "CAP Registration & Upload",
      status: "active",
      date: "July 2 – July 12, 2026",
    },
    {
      name: "Document Verification",
      status: "active",
      date: "July 3 – July 13, 2026",
    },
    {
      name: "Grievance Submission",
      status: "pending",
      date: "July 16 – July 18, 2026",
    },
    { name: "Final Merit List", status: "pending", date: "July 20, 2026" },
    {
      name: "CAP Seat Allotment Rounds",
      status: "pending",
      date: "Starts after Merit List",
    },
  ];
              ...
              {shortlist.length === 0 ? (
                ...
                shortlist.map((item) => (
                  <div
                    ...
                    className="p-5 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center hover:bg-white/5 transition-colors group"
                  >
                    <div>
            ...
            <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
              {capSteps.map((step, i) => (
                <div key={i} className="relative flex items-center gap-4">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 border-2 z-10 bg-slate-900 ${
            ...
            <div className="space-y-3 mt-5">
              <button className="w-full flex items-center justify-between p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors border border-white/5 group text-sm">
                <span className="flex items-center gap-2 text-slate-300 line-through opacity-50">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500" /> Account
                  Created
                </span>
              </button>
