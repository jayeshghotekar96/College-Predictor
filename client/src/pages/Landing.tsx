...
import { Target, Search, BarChart3, ListOrdered, ChevronRight, GraduationCap } from 'lucide-react';
    ...
    <div className="flex-1 w-full bg-slate-900">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            AI-powered prediction using previous cutoff trends, category analysis, and intelligent admission algorithms for MHT-CET students.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-white/5">
            {[
              ...
              >
                <div className="text-3xl md:text-4xl font-heading font-extrabold text-white mb-2">{stat.value}</div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-extrabold text-white mb-4">Everything You Need to Succeed</h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              A complete toolkit designed to eliminate guesswork and optimize your option form for the best possible allotment.
            </p>
          </div>
