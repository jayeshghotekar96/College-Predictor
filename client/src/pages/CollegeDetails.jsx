              ...
              {college.branches.map((branch) => {
                ...
                const latestYear =
                  gopensCutoffs.length > 0
                    ...
                    : "N/A";
                const latestCutoff = gopensCutoffs.find(
                  (c) => c.year === latestYear,
                );
                const gopensPercentile = latestCutoff?.percentile;
                return (
                  <div
                    key={branch.choiceCode}
                    className="p-5 bg-white/5 rounded-xl border border-white/5 hover:border-white/10 hover:bg-white/10 transition-colors flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
                  >
                    <div>
                      ...
                      <p className="text-sm text-slate-400 mt-1">
                        Intake: Approx 60-120 Seats • AICTE Approved
                      </p>
                    </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-white/10">
            ...
            <div className="space-y-4 text-sm font-medium text-slate-300">
              <div className="flex items-start gap-3">
                ...
                <p>
                  {college.collegeName}, {college.district}, Maharashtra, India
                  - 400001
                </p>
              </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-white/10">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={f}
                  className="px-3 py-1.5 bg-white/5 rounded-lg text-xs font-semibold text-slate-300 border border-white/5"
                >
                  {f}
                </span>
              ))}
