...
export function UserActions({ onOpenSearch }) {
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-4">
      ...
      >
        ...
        <kbd className="hidden sm:inline-flex px-1.5 py-0.5 bg-black/40 rounded text-[10px] font-mono border border-white/10">
          ⌘K
        </kbd>
      </button>
