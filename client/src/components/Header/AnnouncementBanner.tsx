        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-6 py-2.5 flex items-center justify-between relative z-10">
            <div className="flex-1 flex items-center justify-center gap-3 text-sm font-medium">
              ...
              <span>
                🚀 CAP Round 1 Prediction Engine is Live. 2025 Official Cutoff Dataset Updated!
              </span>
              <Link to="/predict" className="hidden md:flex items-center gap-1 text-white hover:text-cyan-200 underline underline-offset-4 decoration-white/40 transition-colors font-bold">
