  ...
  return (
    <Link to="/" className="flex items-center gap-3 group">
      ...
      <div className="relative flex items-center justify-center">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 via-cyan-400 to-indigo-500 p-[1px] shadow-[0_0_20px_rgba(56,189,248,0.3)] group-hover:shadow-[0_0_30px_rgba(56,189,248,0.5)] transition-shadow duration-500">
