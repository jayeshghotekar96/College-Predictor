            ...
            >
              ...
              <div className="relative flex items-center px-4 py-4 border-b border-white/5 bg-white/5">
                ...
                {query ? (
                  <button
                    onClick={() => setQuery("")}
                    className="absolute right-6 p-1 bg-white/10 rounded-full hover:bg-white/20 text-slate-300"
                  >
                    <X className="w-4 h-4" />
                  </button>
                ) : (
              ...
              <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
                {query ? (
                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-xs font-heading font-bold text-slate-500 uppercase tracking-wider mb-3 px-2">
                        Matches
                      </h3>
                  ...
                  <div className="space-y-8 py-2">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        <button
                          onClick={() => navigate("/colleges?type=Govt")}
                        ...
                        >
                          ...
                          <span className="text-xs text-slate-500">
                            Explore state-funded autonomous institutes
                          </span>
                        </button>

                        <button
                          onClick={() => navigate("/predict?tab=heatmap")}
                          className="flex flex-col p-3 rounded-xl border border-white/5 hover:bg-white/5 transition-all text-left group"
                        >
                          <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-xs text-slate-500">
                            Compare district competitiveness
                          </span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-xs text-slate-500">
                            Branch specific percentile trends
                          </span>
                        </button>
                      </div>
                    </div>
